...
def callback_for_cities(call: CallbackQuery) -> None:
    ...
    """
    make_log(lvl='info', text=f'callback for cities worked for chat_id {call.message.chat.id}')
...
def callback_checkin_date(call: CallbackQuery) -> None:
    ...
    make_log(lvl='info', text=f'callback for checkin date worked for chat_id {call.message.chat.id}')
...
def callback_checkout_date(call: CallbackQuery) -> None:
    ...
    make_log(lvl='info', text=f'callback for checkout date worked for chat_id {call.message.chat.id}')
...
def get_hotels_amount(message: Message):
    ...
    make_log(lvl='info', text=f'hotels amount asked for chat_id {message.chat.id}')
...
def get_photos_need(call: CallbackQuery) -> None:
    ...
    """
    make_log(lvl='info', text=f'asked photos need for chat_id {call.message.chat.id}')
...
def get_photos_amount(message: Message):
    ...
    make_log(lvl='info', text=f'asked photos amount for chat_id {message.chat.id}')
